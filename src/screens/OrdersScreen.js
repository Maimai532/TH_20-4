...
const styles = StyleSheet.create({
  ...
  statusText: { fontSize: 12, color: '#53B175', fontWeight: '600' },
  ...
  moreText: { fontSize: 14, fontWeight: '700', color: '#555' },

  itemNames: { fontSize: 13, color: '#7C7C7C', marginBottom: 12 },
  ...
  totalPrice: { fontSize: 18, fontWeight: '700', color: '#181725' },
});